...
<template>
  ...
  >
    <!-- Header -->
    <header
      class="sticky top-0 z-50 backdrop-blur-lg bg-white/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-700"
    >
      ...
      <div class="mb-8">
        ...
        >
          ...
          >
            ...
            <div
              v-if="selectedFile"
              class="mt-4 flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800"
            >
              <svg
              ...
              <button
                @click="clearFile"
                class="p-1 hover:bg-blue-100 dark:hover:bg-blue-800 rounded"
              >
                <svg
          ...
          <div
            ...
            class="mt-6 p-6 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-700"
          >
          ...
          <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <label
              class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
              <input
                v-model="options.enhance"
                type="checkbox"
      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- Overlay Info -->
            <div
              class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/0 to-black/0 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-3"
            >
...
const processedImages = ref<
  Array<ProcessedImage & { url: string; loaded: boolean }>
>([]);
